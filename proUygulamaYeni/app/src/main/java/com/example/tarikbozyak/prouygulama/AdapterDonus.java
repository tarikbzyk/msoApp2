...
public class AdapterDonus extends ArrayAdapter<String> {
...
//Bu sınıf Adapter aynı işlemleri yapıyor.Tek farkı dönüş seferleri kullanılıyor.

    public AdapterDonus(Context context,String[] Saat,String Fiyat[],String SeferNo[],int imgs[],String Nerden,String Nereye) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.Nerden.setText(DegerTut.Nereye);
        holder.Nereye.setText(DegerTut.Nerden);
